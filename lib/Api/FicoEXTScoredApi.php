...
namespace FicoEXTScored\Client\Api;
...
use FicoEXTScored\Client\HeaderSelector;
use FicoEXTScored\Client\ObjectSerializer;

class FicoEXTScoredApi
{
    ...
    {
        $returnType = '\FicoEXTScored\Client\Model\Respuesta';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FicoEXTScored\Client\Model\Respuesta',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FicoEXTScored\Client\Model\Errores',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
