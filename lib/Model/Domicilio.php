...
class Domicilio implements ModelInterface, ArrayAccess
{
    ...
    protected static $FicoEXTScoredTypes = [
        ...
        'ciudad' => 'string',
        'estado' => '\FicoEXTScored\Client\Model\CatalogoEstados',
        'cp' => 'string',
        'fecha_residencia' => 'string',
        'numero_telefono' => 'string',
        'tipo_domicilio' => '\FicoEXTScored\Client\Model\CatalogoTipoDomicilio',
        'tipo_asentamiento' => '\FicoEXTScored\Client\Model\CatalogoTipoAsentamiento',
