...
class Persona implements ModelInterface, ArrayAccess
{
    ...
    protected static $FicoEXTScoredTypes = [
        ...
        'curp' => 'string',
        'nacionalidad' => 'string',
        'residencia' => '\FicoEXTScored\Client\Model\CatalogoResidencia',
        'estado_civil' => '\FicoEXTScored\Client\Model\CatalogoEstadoCivil',
        'sexo' => '\FicoEXTScored\Client\Model\CatalogoSexo',
        'clave_elector_ife' => 'string',
        'numero_dependientes' => 'int',
        'fecha_defuncion' => 'string',
        'domicilio' => '\FicoEXTScored\Client\Model\Domicilio'
    ];
